...
@section('content')
    <form class="update-form" action="/mypage/profile" method="POST">
        @method('PATCH')
        @csrf
        <div class="font-weight-bold text-center border-bottom pb-3 pt-3" style="font-size: 24px">商品の出品</div>
        @csrf
        {{-- 商品画像 --}}
        <div>商品画像</div>
        ...
        <div class="form-group mt-3">
            ...
            <input class="condition_detail" type="text" name="condition_text" value="{{ $item ?? ''->condition_text }}">
        </div>
